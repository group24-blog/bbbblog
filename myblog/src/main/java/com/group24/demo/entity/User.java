...
public class User {
    ...
    private Date  time;
    @OneToMany(mappedBy = "articleUser",cascade = CascadeType.ALL,fetch = FetchType.EAGER)
    private List<Blog> blogs=new ArrayList<>();
    @OneToMany
    private List<Comment> comments=new ArrayList<>();
   @OneToMany(mappedBy = "followerUser",cascade = CascadeType.ALL,fetch = FetchType.LAZY)
   private List<Follower> followers=new ArrayList<>();
    @OneToMany(mappedBy = "subscriberUser",cascade = CascadeType.ALL,fetch = FetchType.LAZY)
